...
def main() -> int:
    ...
    parser.add_argument("-f", "--forward", help="Expert compatibility mode: one forward filtered FASTQ.")
    parser.add_argument("-r", "--reverse", help="Expert compatibility mode: one reverse filtered FASTQ.")
    ...
    parser.add_argument("--pear-min", type=int, help="Expert custom minimum; supply together with --pear-max.")
    parser.add_argument("--pear-max", type=int, help="Expert custom maximum; supply together with --pear-min.")
